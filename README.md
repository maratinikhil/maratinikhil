...
> Built a scalable e-commerce backend using Spring Boot microservices, secured with JWT and deployed on AWS EC2.

- ✅ Designed RESTful APIs for product catalog, orders, and user management
- ✅ Implemented **Spring Security + JWT** for authentication & authorization
- ✅ Reduced API response time by **35%** using Redis caching
- ✅ Containerized services using **Docker** and automated CI with **GitHub Actions**

---

## 📜 Certifications

- 🎖️ **Java Full Stack Developer Certification** — Naaima Embedded Technology *(Oct 2024 – Present)*
